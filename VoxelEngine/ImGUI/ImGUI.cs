...
namespace VoxelEngine.ImGUI
{
    internal class ImGUIController
    {

        int _vertexBufferSize = 10000;
        int _vertexArray;

        int _indexBufferSize = 2000;
        int _vertexBuffer;
        ...
        private void RenderImDrawData(ImDrawDataPtr draw_data)
        {
            ...
            prevScissorBox[0] = GL.GetInteger(GetPName.ScissorBox);
         
            Span<int> prevPolygonMode = stackalloc int[2];
            prevPolygonMode[0] = GL.GetInteger(GetPName.PolygonMode);
...
void main()
{
    ...
    texCoord = in_texCoord;
        ...
        static string fragmentSource = @"#version 330 core
